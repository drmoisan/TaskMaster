...
namespace ToDoModel
{
    public class ToDoDefaults
    {
        public ToDoDefaults()
        {
            ...
            {
                new PrefixItem(
                    prefixType: PrefixTypeEnum.People,
                    key: "People",
                    value: defaults.Prefix_People,
                    color: OlCategoryColor.olCategoryColorDarkGray,
                    defaults.UDF_People
                ),
                new PrefixItem(
                    ...
                    defaults.UDF_Project
                ),
                new PrefixItem(
                    prefixType: PrefixTypeEnum.Program,
                    key: "Program",
                    value: Properties.Settings.Default.Prefix_Program,
                    color: OlCategoryColor.olCategoryColorTeal,
                    defaults.UDF_Program
                ),
                new PrefixItem(
                    prefixType: PrefixTypeEnum.Topic,
                    key: "Topic",
                    value: Properties.Settings.Default.Prefix_Topic,
                    color: OlCategoryColor.olCategoryColorDarkTeal,
                    defaults.UDF_Topic
                ),
                new PrefixItem(
                    prefixType: PrefixTypeEnum.Context,
                    key: "Context",
                    value: Properties.Settings.Default.Prefix_Context,
                    color: OlCategoryColor.olCategoryColorNone,
                    defaults.UDF_Context
                ),
                new PrefixItem(
                    prefixType: PrefixTypeEnum.Today,
                    key: "Today",
                    value: Properties.Settings.Default.Prefix_Today,
                    color: OlCategoryColor.olCategoryColorDarkRed,
                    ""
                ),
                new PrefixItem(
                    prefixType: PrefixTypeEnum.Bullpin,
                    key: "Bullpin",
                    value: Properties.Settings.Default.Prefix_Bullpin,
                    color: OlCategoryColor.olCategoryColorOrange,
                    ""
                ),
                new PrefixItem(
                    prefixType: PrefixTypeEnum.KB,
                    key: "KB",
                    value: Properties.Settings.Default.Prefix_KB,
    ...
    {
        public PrefixItem(
            PrefixTypeEnum prefixType,
            string key,
            string value,
            OlCategoryColor color,
            string olUserFieldName
        )
        {
        ...
        public string OlUserFieldName
        {
            get => _olUserFieldName;
            set => _olUserFieldName = value;
        }
    }
}
