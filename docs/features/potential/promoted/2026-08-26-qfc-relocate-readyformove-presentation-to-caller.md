# Relocate the `ReadyForMove` presentation to the caller (Issue #630)

- Date captured: 2026-08-26
- Author: Dan Moisan
- Status: Promoted -> docs/features/active/Relocate_the_ReadyForMove_presentation_to_the_caller/ (Issue #630)
...
- Issue: #630
- Issue URL: https://github.com/drmoisan/TaskMaster/issues/630
