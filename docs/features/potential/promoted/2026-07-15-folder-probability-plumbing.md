# folder-probability-plumbing (Potential)

- Date captured: 2026-07-15
- Author: Dan Moisan
- Status: Promoted -> Issue #324 (https://github.com/drmoisan/TaskMaster/issues/324) -> docs/features/active/2026-07-15-folder-probability-plumbing-324/
...
- [x] Promote to GitHub issue (feature request template) -> Issue #324
- [x] Create `docs/features/active/2026-07-15-folder-probability-plumbing-324/` folder from the template
