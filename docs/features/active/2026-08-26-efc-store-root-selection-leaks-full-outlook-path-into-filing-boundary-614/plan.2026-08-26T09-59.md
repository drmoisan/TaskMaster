# efc-store-root-selection-leaks-full-outlook-path-into-filing-boundary (Plan)

- **Issue:** #614
- **Parent (optional):** none
- **Owner:** drmoisan
- **Last Updated:** 2026-08-26T09-59
- **Status:** Draft
- **Version:** 0.1
...
- [ ] [P2-T1] [expect-fail] Add a small, deterministic regression test in the standard module file (use `tests/bugs/<YYYY>/#614-<desc>.py` only if no clear home exists)
