...
- Outputs (artifacts, logs, telemetry): four verification-run evidence artifacts under
  `docs/features/active/utilitiescs-nullable-ci-capstone/evidence/other/` (fail-before,
...
- [ ] Each of the four verification runs (clean baseline, opted-in-defect fail,
  ...
  `docs/features/active/utilitiescs-nullable-ci-capstone/evidence/other/`, and `git status` is
  clean at hand-off.
