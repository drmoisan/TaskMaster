# QA Gate — Diff Content Check: `.github/workflows/_mstest-coverage.yml`
...
Command: `git diff --cached origin/main -- .github/workflows/_mstest-coverage.yml`
...
Cross-check: `git diff --cached origin/main --numstat -- .github/workflows/_mstest-coverage.yml` independently reports `16	0` for this file.
