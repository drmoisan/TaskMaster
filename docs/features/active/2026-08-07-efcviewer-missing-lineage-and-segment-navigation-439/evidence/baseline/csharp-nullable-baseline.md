Timestamp: 2026-08-24T18:13:25.0000000-04:00
Command: msbuild TaskMaster.sln /t:Build /p:Configuration=Debug /p:Platform='Any CPU' /p:Nullable=enable /p:TreatWarningsAsErrors=true
EXIT_CODE: 1
Output Summary: Baseline nullable build could not evaluate compiler or nullable diagnostics because 37 pre-existing package/assembly restore errors stopped the solution build. Compiler diagnostic count: 0. Nullable diagnostic count: 0. Build warnings: 4.
...
---
Timestamp: 2026-08-24T18:17:27-04:00
Command: msbuild TaskMaster.sln /t:Build /p:Configuration=Debug /p:Platform='Any CPU' /p:Nullable=enable /p:TreatWarningsAsErrors=true
EXIT_CODE: 0
Output Summary: Successful nullable baseline retry. Compiler diagnostic count: 0. Nullable diagnostic count: 0. Build warnings: 5, all existing System.Reactive packages.config support warnings.
