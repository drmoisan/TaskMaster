# 2026-08-27-efc-enter-activates-valid-highlighted-suggestion (Plan)

- **Issue:** #641
- **Parent (optional):** none
- **Owner:** drmoisan
- **Last Updated:** 2026-08-27T08-46
- **Status:** Draft
- **Version:** 0.1
...
- [ ] [P2-T1] [expect-fail] Add a small, deterministic regression test in the standard module file (use `tests/bugs/<YYYY>/#641-<desc>.py` only if no clear home exists)
