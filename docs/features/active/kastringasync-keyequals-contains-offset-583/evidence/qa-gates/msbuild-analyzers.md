# MSBuild Analyzer Rebuild (Post-Change, P5-T3)

- Timestamp: 2026-09-13T01-50
...
- "CoreCompile:" occurrences: 192 (non-vacuous rebuild)

## Output Summary

Exit code 0; verdict "Build succeeded."; "Skipping target CoreCompile" count of exactly 0;
"CoreCompile:" count of 192 (>= 9, non-vacuous); recorded warning count is 0, which is no
greater than the P0-T6 baseline ceiling of 0. Matches the recorded shape at
