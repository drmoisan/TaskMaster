# 2026-09-13-quickfiler-transactiongate-permit-leak-unexcluded (Plan)

- **Issue:** #882
- **Parent (optional):** none
- **Owner:** drmoisan
- **Last Updated:** 2026-09-13T18-24
- **Status:** Draft
- **Version:** 0.1
...
- [ ] [P2-T1] [expect-fail] Add a small, deterministic regression test in the standard module file (use `tests/bugs/<YYYY>/#882-<desc>.py` only if no clear home exists)
