...
- [x] (#869) The actual context name is captured from a live run against the pull request head SHA using the check-runs query the workflow README prescribes, and recorded in the evidence directory; it is labelled predicted until that capture confirms it.
