# coverage-metric-includes-test-assemblies (Plan)

- **Issue:** #193
- **Parent (optional):** none
- **Owner:** drmoisan
- **Last Updated:** 2026-06-12T21-54
- **Status:** Draft
- **Version:** 0.1
...
- [ ] [P2-T1] [expect-fail] Add a small, deterministic regression test in the standard module file (use `tests/bugs/<YYYY>/#193-<desc>.py` only if no clear home exists)
