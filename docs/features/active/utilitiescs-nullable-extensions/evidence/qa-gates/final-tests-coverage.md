...
Command: `pwsh scripts/vscode/Invoke-MSTestWithCoverage.ps1 -CoverageOutput docs/features/active/utilitiescs-nullable-extensions/evidence/qa-gates/final-coverage.cobertura.xml` (run after a clean normal `msbuild TaskMaster.sln /t:Build`)
