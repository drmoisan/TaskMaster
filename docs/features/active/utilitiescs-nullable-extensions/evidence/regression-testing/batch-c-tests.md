...
Command: `pwsh scripts/vscode/Invoke-MSTestWithCoverage.ps1 -CoverageOutput docs/features/active/utilitiescs-nullable-extensions/evidence/regression-testing/batch-c-coverage.cobertura.xml` (run after a normal `msbuild TaskMaster.sln /t:Build`)
