# 2026-04-21-outlook-startup-store-rewire-ui-lock-instrumentation (Plan)

- **Issue:** #139
- **Parent (optional):** none
- **Owner:** drmoisan
- **Last Updated:** 2026-04-21T19-43
- **Status:** Draft
- **Version:** 0.1
...
- [ ] [P2-T1] [expect-fail] Add a small, deterministic regression test in the standard module file (use `tests/bugs/<YYYY>/#139-<desc>.py` only if no clear home exists)
