...
- [x] Implement the fix and record evidence (2026-09-06; see Outcome below)
- [ ] Human live-Outlook confirmation per `runbooks/live-outlook-cancel-teardown-verification.runbook.md` (human-interaction exception HI-1; does not gate the automated review)
