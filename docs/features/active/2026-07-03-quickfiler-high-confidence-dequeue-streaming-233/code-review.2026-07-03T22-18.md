...
|---|---|---|---|---|---|---|
| Blocker | `docs/features/active/2026-07-03-quickfiler-high-confidence-dequeue-streaming-233/code-review.2026-07-03T22-10.md` and related issue #233 review/remediation artifacts | multiple metadata lines | `git diff --check ec4af1f0924b175a725fe50a5d2a61f7d27a3318...HEAD` fails on trailing whitespace in review/remediation artifacts. | Remove trailing whitespace from the listed issue #233 markdown artifacts and rerun the base-to-head whitespace check. | The branch cannot satisfy repository code-quality readiness while the current diff check fails. | Live review command exit 1; examples include `code-review.2026-07-03T22-10.md:3`, `feature-audit.2026-07-03T22-10.md:3`, `policy-audit.2026-07-03T22-10.md:3`, and `remediation-inputs.2026-07-03T19-16.md:3`. |
