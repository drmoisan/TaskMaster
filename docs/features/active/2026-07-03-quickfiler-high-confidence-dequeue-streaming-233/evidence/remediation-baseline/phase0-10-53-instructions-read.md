...
4. C# rules from AGENTS.md and .agents/skills/csharp/SKILL.md
5. Atomic execution rules from policy-compliance-order, atomic-plan-contract, atomic-executor, acceptance-criteria-tracking, and evidence-and-timestamp-conventions
...
Output Summary: Required policy, plan, remediation input, audit, and acceptance source files were read before execution. The remediation plan was validated with validate_orchestration_artifacts as artifact_type plan before task execution began.
