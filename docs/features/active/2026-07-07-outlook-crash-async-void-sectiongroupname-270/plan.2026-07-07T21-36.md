# outlook-crash-async-void-sectiongroupname (Plan)

- **Issue:** #270
- **Parent (optional):** none
- **Owner:** drmoisan
- **Last Updated:** 2026-07-07T21-36
- **Status:** Draft
- **Version:** 0.1
...
- [ ] [P2-T1] [expect-fail] Add a small, deterministic regression test in the standard module file (use `tests/bugs/<YYYY>/#270-<desc>.py` only if no clear home exists)
