# 2026-08-27-efc-keyboard-navigation-keeps-highlighted-row-visible (Plan)

- **Issue:** #640
- **Parent (optional):** none
- **Owner:** drmoisan
- **Last Updated:** 2026-08-27T08-23
- **Status:** Draft
- **Version:** 0.1
...
- [ ] [P2-T1] [expect-fail] Add a small, deterministic regression test in the standard module file (use `tests/bugs/<YYYY>/#640-<desc>.py` only if no clear home exists)
