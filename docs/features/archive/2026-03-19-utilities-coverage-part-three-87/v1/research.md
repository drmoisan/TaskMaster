...
Two files (FileIO2 and StringManipulation) remain in a "To Depricate" folder and are still compiled. Consider whether they should simply be removed rather than tested.
