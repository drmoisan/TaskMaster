Timestamp: 2026-07-04T10:22:21-04:00

Policy Order:
- AGENTS.md standing instructions
- AGENTS.md cross-language code change policy
- AGENTS.md cross-language unit test policy
- .agents/skills/csharp/SKILL.md for C# scope
- .agents/skills/feature-review/SKILL.md for review artifact requirements
- .agents/skills/atomic-plan-contract/SKILL.md for atomic execution and evidence requirements
