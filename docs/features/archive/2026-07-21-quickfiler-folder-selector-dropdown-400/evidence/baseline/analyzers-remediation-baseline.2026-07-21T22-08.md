...
EXIT_CODE: 0
Output Summary: Analyzer-enabled solution build succeeded with 5 existing System.Reactive packages.config compatibility warnings and 0 errors. No analyzer regression was reported.

Complete command result:

```text
MSBuild version 18.8.2+ce25c0108 for .NET Framework
Build started 7/21/2026 6:08:03 PM.
