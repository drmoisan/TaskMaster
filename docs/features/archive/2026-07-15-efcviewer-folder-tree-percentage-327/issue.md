# efcviewer-folder-tree-percentage (Issue #327)

- Date captured: 2026-07-15
- Author: Dan Moisan
- Status: Promoted -> docs/features/active/efcviewer-folder-tree-percentage/ (Issue #327)
- Epic: folder-tree-percentage-ui (child feature, wave 1)
- Depends on: folder-probability-plumbing (upstream probability contract)

- Issue: #327
- Issue URL: https://github.com/drmoisan/TaskMaster/issues/327
...
- [ ] Create `docs/features/active/efcviewer-folder-tree-percentage/` folder from the template
