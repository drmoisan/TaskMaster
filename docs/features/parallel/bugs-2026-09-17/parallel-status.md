...
| `last_updated` | 2026-09-17T01-05 |
| `next_step` | SEED_ITEM_895_EXECUTION_SESSION_AND_LAUNCH |
...
| --- | --- | --- | --- | --- | --- | --- |
| 895 | `docs/features/active/2026-09-14-fsharp-core-hintpath-netstandard21-skew-895` | 0 | scheduled | not_started | - | - |
