...
//                if (Action == "EventLog")
//                {
//                    strTemp = StartDate.ToString("General Date") + " TO " + _endDate.ToString("h:mm:ss AM/PM") + "| DUR: " + lngMinutes + " minutes " + lngSeconds2 + " seconds" + " |" + lngMinutes2.ToString("##0.0000") + " | " + "APP: " + Subject + " | " + "PROC: " + ProcName;
//                }
...
//                else
//                {
//                    strTemp = "|" + _endDate.ToString("General Date") + "| Duration: " + lngMinutes + " minutes " + lngSeconds2 + " seconds" + " |" + lngMinutes2.ToString("##0.0000") + "| Action: " + Action + " | Subject: " + Subject + " | From: " + SentFrom + " | To: " + SentTo;
//                }
//                ToStringRet = strTemp;
//                return ToStringRet;
//            }
