    ...
    internal static class EfcThemeHelper
    {
        ...
        )
        {
            ...
            var lightNormal = new Dictionary<string, ThemeControlGroup>
            {
                ...
                {
                    "Tips",
                    new ThemeControlGroup(controls: tips, back: Color.Black, fore: Color.White)
                },
                {
                    "Default2Color",
            ...
            var lightActive = new Dictionary<string, ThemeControlGroup>
            {
                ...
                },
                {
                    ...
                    new ThemeControlGroup(
                        controls: mail,
                        backMain: Color.LightCyan,
                        foreMain: SystemColors.ControlText,
                        backAlt: Color.LightCyan,
                        foreAlt: Color.MediumBlue,
                        isAlt: isAlt
                    )
                },
            ...
            var darkActive = new Dictionary<string, ThemeControlGroup>
            {
                ...
                },
                {
                    ...
                    new ThemeControlGroup(
                        controls: mail,
                        backMain: Color.FromArgb(64, 64, 64),
                        foreMain: Color.WhiteSmoke,
                        backAlt: Color.FromArgb(64, 64, 64),
                        foreAlt: Color.Goldenrod,
                        isAlt: isAlt
                    )
                },
        ...
        )
        {
            ...
            var lightNormal = new Dictionary<string, ThemeControlGroup>
            {
                //{ "Nav", new ThemeControlGroup(controls: nav, back: SystemColors.HotTrack, fore: SystemColors.Control) },
                {
                    ...
                    new ThemeControlGroup(
                        controls: tips,
                        back: SystemColors.ControlText,
                        fore: SystemColors.Control
                    )
                },
                {
                    "highlighted",
                ...
                },
                {
                    ...
                    new ThemeControlGroup(
                        ...
                        isAltHover: (x) => ((Button)x).DialogResult == DialogResult.OK
                    )
                },
                {
                    "CheckBoxes",
                    new ThemeControlGroup(
                        ...
                        foreAlt: SystemColors.ControlText,
                        hover: Color.LightCyan,
                        isAltHover: (x) => ((CheckBox)x).Checked
                    )
                },
            };
            var lightActive = new Dictionary<string, ThemeControlGroup>
