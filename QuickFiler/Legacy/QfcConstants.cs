...
namespace QuickFiler.Legacy
{
    internal static class QfcConstants
    {
        public class ConstantGroup
        {
            ...
            private int _top;
            private int _left;
            internal static double Multiplier
            {
                get => (double)(PInvoke.ScreenHeight / (double)1080);
            }
        ...
        internal static int RightAligned
        {
            get => (int)Math.Round(Multiplier * _rightAligned, 0);
        }
        ...
        internal static ConstantGroup Panel
        {
            get => new ConstantGroup(width: 655, height: 112, left: 12);
        }
        internal static ConstantGroup Lbl1
        {
            get => new ConstantGroup(width: 54, height: 16, left: 6, top: _topOffsetC);
        }
        ...
        internal static ConstantGroup Lbl5
        {
            get => new ConstantGroup(width: 60, height: 16, left: 372, top: _topOffsetC);
        }
        internal static ConstantGroup LblSender
        {
            get => new ConstantGroup(width: 174, height: 16, left: 6, top: _topOffsetC);
        }
        internal static ConstantGroup LblTriage
        {
            get => new ConstantGroup(width: 11, height: 16, left: 181, top: _topOffsetC);
        }
        internal static ConstantGroup LblActionable
        {
            get => new ConstantGroup(width: 72, height: 16, left: 198, top: _topOffsetC);
        }
        ...
        internal static ConstantGroup LblSentOn
        {
            get => new ConstantGroup(width: 156, height: 16, left: 200, top: _topOffsetC);
        }
        ...
        internal static ConstantGroup Inpt
        {
            get => new ConstantGroup(width: 126, height: 24, left: 438, top: _topOffsetC);
        }
        ...
        internal static ConstantGroup LblPos
        {
            get => new ConstantGroup(width: 20, height: 20, left: 0, top: _topOffsetC);
        }
        internal static ConstantGroup LblAcF
        {
            get =>
                new ConstantGroup(
                    width: 14,
                    height: 14,
                    left: 363,
                    top: (int)Math.Max(_topOffsetC - 2, 0)
                );
        }
        internal static ConstantGroup LblAcD
        {
            get => new ConstantGroup(width: 14, height: 14, left: 363, top: _topOffsetC + 20);
        }
        ...
        #region fields
        internal static int Top_Offset
        {
            get => (int)Math.Round(Multiplier * _topOffset, 0);
        }
        internal static int Lbl_height16
        {
            get => (int)Math.Round(Multiplier * _lbl_height16, 0);
        }
        internal static int Lbl_height24
        {
            get => (int)Math.Round(Multiplier * _lbl_height24, 0);
        }
        internal static int Space16
        {
            get => (int)Math.Round(Multiplier * _space16, 0);
        }
        internal static int Space32
        {
            get => (int)Math.Round(Multiplier * _space32, 0);
        }
        internal static int Space36
        {
            get => (int)Math.Round(Multiplier * _space36, 0);
        }
        internal static int Space40
        {
            get => (int)Math.Round(Multiplier * _space40, 0);
        }
        internal static int Space48
        {
            get => (int)Math.Round(Multiplier * _space48, 0);
        }
        internal static int Space56
        {
            get => (int)Math.Round(Multiplier * _space56, 0);
        }

        internal static int Top_Offset_C
        {
            get => (int)Math.Round(Multiplier * _topOffsetC, 0);
        }
        internal static int Left_frm
        {
            get => (int)Math.Round(Multiplier * left_frm, 0);
        }
        internal static int Left_lblPos
        {
            get => (int)Math.Round(Multiplier * left_lblPos, 0);
        }
        ...
        internal static int Left_cbDelItem
        {
            get => (int)Math.Round(Multiplier * left_cbDelItem, 0);
        }
        internal static int Left_cbKllItem
        {
            get => (int)Math.Round(Multiplier * left_cbKllItem, 0);
        }
        internal static int Left_cbFlagItem
        {
            get => (int)Math.Round(Multiplier * left_cbFlagItem, 0);
        }
        internal static int Width_frm
        {
            get => (int)Math.Round(Multiplier * width_frm, 0);
        }
        internal static int Width_lblPos
        {
            get => (int)Math.Round(Multiplier * width_lblPos, 0);
        }
        internal static int Width_chbxSaveMail
        {
            get => (int)Math.Round(Multiplier * width_chbxSaveMail, 0);
        }
        internal static int Width_chbxGPConv
        {
            get => (int)Math.Round(Multiplier * width_chbxGPConv, 0);
        }
        internal static int Width_cb
        {
            get => (int)Math.Round(Multiplier * width_cb, 0);
        }
        internal static int Height_UserForm
        {
            get => (int)Math.Round(Multiplier * height_UserForm, 0);
        }
        internal static int Width_UserForm
        {
            get => (int)Math.Round(Multiplier * width_UserForm, 0);
        }
        internal static int Width_PanelMain
        {
            get => (int)Math.Round(Multiplier * width_PanelMain, 0);
        }
        ...
        internal static int FrmSp
        {
            get => (int)Math.Round(Multiplier * frmSp, 0);
        }
        internal static int OK_left
        {
            get => (int)Math.Round(Multiplier * oK_left, 0);
        }
        internal static int CANCEL_left
        {
            get => (int)Math.Round(Multiplier * cANCEL_left, 0);
        }
        internal static int OK_width
        {
            get => (int)Math.Round(Multiplier * oK_width, 0);
        }
        internal static int UNDO_left
        {
            get => (int)Math.Round(Multiplier * uNDO_left, 0);
        }
        internal static int UNDO_width
        {
            get => (int)Math.Round(Multiplier * uNDO_width, 0);
        }
        internal static int Spn_left
        {
            get => (int)Math.Round(Multiplier * spn_left, 0);
        }
        #endregion
    }
}
