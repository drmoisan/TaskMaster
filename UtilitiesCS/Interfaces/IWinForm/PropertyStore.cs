    ...
    public class PropertyStore
    {
        ...
        public Color GetColor(int key, out bool found)
        {
            ...
            if (found)
            {
                ...
                {
                    Debug.Fail(
                        "Have non-null object that isnt a color wrapper stored in a color entry!\r\nDid someone SetObject instead of SetColor?"
                    );
                }
#endif
            }
        ...
        public Padding GetPadding(int key, out bool found)
        {
            ...
            if (found)
            {
                ...
                {
                    Debug.Fail(
                        "Have non-null object that isnt a padding wrapper stored in a padding entry!\r\nDid someone SetObject instead of SetPadding?"
                    );
                }
#endif
            }
        ...
        public Rectangle GetRectangle(int key, out bool found)
        {
            ...
            if (found)
            {
                ...
                {
                    Debug.Fail(
                        "Have non-null object that isnt a Rectangle wrapper stored in a Rectangle entry!\r\nDid someone SetObject instead of SetRectangle?"
                    );
                }
#endif
            }
        ...
        public void SetColor(int key, Color value)
        {
            ...
            else
            {
                ...
                else
                {
                    Debug.Assert(
                        storedObject == null,
                        "object should either be null or ColorWrapper"
                    ); // could someone have SetObject to this key behind our backs?
                    SetObject(key, new ColorWrapper(value));
                }
            }
        }
        ...
        public void SetPadding(int key, Padding value)
        {
            ...
            else
            {
                ...
                else
                {
                    Debug.Assert(
                        storedObject == null,
                        "object should either be null or PaddingWrapper"
                    ); // could someone have SetObject to this key behind our backs?
                    SetObject(key, new PaddingWrapper(value));
                }
            }
        ...
        public void SetRectangle(int key, Rectangle value)
        {
            ...
            else
            {
                ...
                else
                {
                    Debug.Assert(
                        storedObject == null,
                        "object should either be null or RectangleWrapper"
                    ); // could someone have SetObject to this key behind our backs?
                    SetObject(key, new RectangleWrapper(value));
                }
            }
        ...
        public void SetSize(int key, Size value)
        {
            ...
            else
            {
                ...
                else
                {
                    Debug.Assert(
                        storedObject == null,
                        "object should either be null or SizeWrapper"
                    ); // could someone have SetObject to this key behind our backs?
                    SetObject(key, new SizeWrapper(value));
                }
            }
        ...
        public void SetInteger(int key, int value)
        {
            ...
            if (!LocateIntegerEntry(entryKey, out index))
            {
                ...
                else
                {
                    ...
                    Debug.Assert(
                        index == 0,
                        "LocateIntegerEntry should have given us a zero index."
                    );
                }
        ...
        public void SetObject(int key, object value)
        {
            ...
            if (!LocateObjectEntry(entryKey, out index))
            {
                ...
                else
                {
                    ...
                    Debug.Assert(
                        index == 0,
                        "LocateObjectEntry should have given us a zero index."
                    );
                }
        ...
        private void Debug_VerifyLocateIntegerEntry(int index, short entryKey, int length)
        {
            ...
            do
            {
                ...
                if (currentKeyIndex == entryKey)
                {
                    Debug.Assert(
                        index == idx,
                        "GetIntegerEntry in property store broken. index is "
                            + index
                            + " while it should be "
                            + idx
        ...
        private void Debug_VerifyLocateObjectEntry(int index, short entryKey, int length)
        {
            ...
            do
            {
                ...
                if (currentKeyIndex == entryKey)
                {
                    Debug.Assert(
                        index == idx,
                        "GetObjEntry in property store broken. index is "
                            + index
                            + " while is should be "
                            + idx
                            + "length of the array is "
