...
namespace UtilitiesCS.ReusableTypeClasses
{
    public interface ISmartSerializableNonTyped
    {
        ...
        T Deserialize<T>(string fileName, string folderPath)
            where T : class, ISmartSerializable<T>, new();
        T Deserialize<T>(string fileName, string folderPath, bool askUserOnError)
            where T : class, ISmartSerializable<T>, new();
        T Deserialize<T>(
            string fileName,
            string folderPath,
        ...
        Task<T> DeserializeAsync<T, U>(
            ...
            where T : class, new()
            where U : class, ISmartSerializable<U>, new();
        T DeserializeObject<T>(string json, JsonSerializerSettings settings)
            where T : class;
