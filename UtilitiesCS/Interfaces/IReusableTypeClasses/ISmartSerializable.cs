...
{
    public interface ISmartSerializable<T> : INotifyPropertyChanged
        where T : class, ISmartSerializable<T>, new()
    {
        ...
        T Deserialize<U>(SmartSerializable<U> loader)
            where U : class, ISmartSerializable<U>, new();
        T Deserialize<U>(SmartSerializable<U> loader, bool askUserOnError, Func<T> altLoader)
            where U : class, ISmartSerializable<U>, new();
        Task<T> DeserializeAsync<U>(SmartSerializable<U> config)
            where U : class, ISmartSerializable<U>, new();
        Task<T> DeserializeAsync<U>(SmartSerializable<U> config, bool askUserOnError)
            where U : class, ISmartSerializable<U>, new();
        Task<T> DeserializeAsync<U>(
