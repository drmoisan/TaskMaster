...
namespace UtilitiesCS.ReusableTypeClasses.Concurrent.Observable.Dictionary
{
        ...
        : IConcurrentDictionary<TKey, TValue>
    {
        ...
        Dictionary<TKey, HashSet<IDictionaryObserver<TKey, TValue>>> AddPartialObserver(
        ...
        Dictionary<TKey, HashSet<IDictionaryObserver<TKey, TValue>>> RemovePartialObserver(
            IDictionaryObserver<TKey, TValue> observer
        );
        Dictionary<TKey, HashSet<IDictionaryObserver<TKey, TValue>>> RemovePartialObserver(
            IDictionaryObserver<TKey, TValue> observer,
