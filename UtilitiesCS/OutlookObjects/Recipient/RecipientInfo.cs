...
namespace UtilitiesCS
{
    ...
    public class RecipientInfo : IRecipientInfo
    {
        ...
        public bool Equals(IRecipientInfo other)
        {
            ...
            else if (other.Name.IsNullOrEmpty() & other.Address.IsNullOrEmpty())
            {
                return false;
            }
            else if (Name.IsNullOrEmpty() & Address.IsNullOrEmpty())
            {
                return false;
            }
            else if ((Name ?? "") == (other.Name ?? "") && (Address ?? "") == (other.Address ?? ""))
            {
                return true;
            }
            else
