...
namespace UtilitiesCS.OutlookExtensions
{
    public class OutlookItemFlaggableTry : OutlookItemTry, IOutlookItemFlaggable
    {
        ...
        public OutlookItemFlaggableTry(IOutlookItemFlaggable olItem)
            : base(olItem)
        {
            OlItem = olItem;
        }
        ...
        {
            get => TryGet(() => OlItem.Complete);
            set => TrySet((x) => OlItem.Complete = x, value);
        }
        public DateTime DueDate
        {
            get => TryGet(() => OlItem.DueDate);
            set => TrySet((x) => OlItem.DueDate = x, value);
        }
        public bool FlagAsTask
        {
            get => TryGet(() => OlItem.FlagAsTask);
            set => TrySet((x) => OlItem.FlagAsTask = x, value);
        }
        ...
        {
            get => TryGet(() => OlItem.TotalWork);
            set => TrySet((x) => OlItem.TotalWork = x, value);
        }
