...
namespace ToDoModel.Data_Model.People
{
    public class WrapperPeopleScoDictionaryNew //<TDerived, TKey, TValue> where TDerived : PeopleScoDictionaryNew
    {
        ...
        public PeopleScoDictionaryNew ToDerived()
        {
            ...
            var derivedInstance = (PeopleScoDictionaryNew)
                Activator.CreateInstance(typeof(PeopleScoDictionaryNew), true);
            ...
            var configField = typeof(PeopleScoRemainingObject).GetField(
            ...
            {
                logger.Error(
                    "Config field is null in RemainingObject or did not deserialize correctly."
                );
            }
            ...
            foreach (var derivedField in derivedFields)
            {
                ...
                {
                    derivedField.SetValue(derivedInstance, fieldValue);
                }
            }
