...
namespace UtilitiesCS.OutlookExtensions
{
    ...
    {
        protected OutlookItemFlaggable OlItem { get; set; }

        public OutlookItemFlaggableTry(OutlookItemFlaggable olItem) : base(olItem) { OlItem = olItem; }
        ...
        public DateTime TaskStartDate { get => TryGet(() => OlItem.TaskStartDate); set => TrySet((x) => OlItem.TaskStartDate = x, value); }
