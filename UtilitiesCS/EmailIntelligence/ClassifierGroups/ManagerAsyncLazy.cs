...
namespace UtilitiesCS
{
    public class ManagerAsyncLazy : ConcurrentObservableDictionary<string, AsyncLazy<BayesianClassifierGroup>>
    {
        ...
        private ConcurrentDictionary<string, NewSmartSerializableLoader> _privateConfig;
        ...
        {
            if (e.PropertyName.Contains(nameof(NewSmartSerializableLoader.Config.ClassifierActivated)))
            {
        ...
        internal async void Config_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            var local = config.ActiveDisk == INewSmartSerializableConfig.ActiveDiskEnum.Local;
        ...
        private async Task UpdateLoaderConfigAsync(INewSmartSerializableConfig config, NewSmartSerializableLoader loader)
        {
        ...
        private async Task ChangeDiskCallbackAsync(object sender, PropertyChangedEventArgs e, Type sst, bool local, string name, NewSmartSerializableLoader loader)
        {
        ...
        internal AsyncLazy<BayesianClassifierGroup> GetAsyncLazyClassifierLoader(NewSmartSerializableLoader loader)
        {
        ...
        public void ResetLoadClassifierAsyncLazy(string name, NewSmartSerializableLoader loader) 
        {
