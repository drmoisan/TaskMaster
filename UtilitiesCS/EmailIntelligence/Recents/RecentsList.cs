...
namespace UtilitiesCS
{
    public class RecentsList<T> : ScoCollection<T>
    {
        ...
        public RecentsList(List<T> listOfT, int max)
            : base(listOfT)
        {
            Max = max;
            _ct = _cts.Token;
        ...
        public RecentsList(IEnumerable<T> IEnumerableOfT, int max)
            : base(IEnumerableOfT)
        {
            Max = max;
            _ct = _cts.Token;
        ...
        public RecentsList(string filename, string folderpath, int max)
