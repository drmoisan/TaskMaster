...
namespace UtilitiesCS
{
    public class FlagTranslator : IFlagTranslator
    {
        ...
        {
            get => _getStrFunc(true);
            set => _setStrFunc(true, value);
        }
        public string AsStringNoPrefix
        {
            get => _getStrFunc(false);
            set => _setStrFunc(false, value);
        }
        public ObservableCollection<string> AsListWithPrefix
        {
            get => _getListFunc(true);
            set => _setListFunc(true, value);
        }
        public ObservableCollection<string> AsListNoPrefix
        {
            get => _getListFunc(false);
            set => _setListFunc(false, value);
        }
    }
}
