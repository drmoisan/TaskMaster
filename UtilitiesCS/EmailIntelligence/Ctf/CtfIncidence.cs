...
namespace UtilitiesCS
{
    ...
    public class CtfIncidence : IComparable<CtfIncidence>
    {
        ...
        public int MaxFoldersPerConv
        {
            get => _maxFoldersPerConv;
        ...
        public List<string> EmailFolders
        {
            get => _emailFolders;
            set => _emailFolders = value;
        }

        public List<int> EmailCounts
        {
            get => _emailCounts;
            set => _emailCounts = value;
        }
