...
namespace UtilitiesCS
{
        ...
        where T : class
    {
        ...
        public VerboseLogger()
        {
            ...
            var dict = methods
                .Select(x => new KeyValuePair<string, bool>(x.Name, false))
                .Distinct()
                .ToDictionary();
        ...
        public void SetVerbose(IEnumerable<string> methodNames) =>
            methodNames.ForEach(name => VerboseMethods[name] = true);
