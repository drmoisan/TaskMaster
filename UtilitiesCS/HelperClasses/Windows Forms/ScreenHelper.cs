...
namespace UtilitiesCS.Windows_Forms
{
    public static class ScreenHelper
    {
        ...
        {
            if (Screen.AllScreens.Count() < 2 || container is null || container.IsDisposed)
            {
                return false;
            }

            if (container.Location.TryGetScreen(out Screen sourceScreen, out int screenNumber))
            {
                return false;
            }
        ...
        internal static (Screen Screen, int ScreenNumber) GetScreen(this Point point)
        {
            ...
            if (screenNumber == -1)
            {
                throw new ArgumentOutOfRangeException($"point {point} not on any screen");
            }
        ...
        public static Point SwitchTo(this Point point, Screen targetScreen, bool withScaling)
        {
            ...
            {
                throw new ArgumentNullException(nameof(targetScreen));
            }
            ...
            if (withScaling)
            {
                scalingFactorX =
                    currentScreen.Bounds.Width <= 0
                        ? 1
                        : targetScreen.Bounds.Width / (double)currentScreen.Bounds.Width;
                scalingFactorY =
                    currentScreen.Bounds.Height <= 0
                        ? 1
                        : targetScreen.Bounds.Height / (double)currentScreen.Bounds.Height;
            }
        ...
        public static bool TrySwitchTo(
            this Point point,
            Screen targetScreen,
            bool withScaling,
            out Point newPoint
        )
        {
            ...
            if (
                ...
                || TryGetScreen(point, out sourceScreen, out screenNumber)
            )
            {
                return false;
            }
        ...
        /// <exception cref="ArgumentNullException"></exception>
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        public static Point SwitchScreens(
            this Point point,
            Screen sourceScreen,
            Screen targetScreen,
            bool withScaling
        )
        {
            ...
            {
                throw new ArgumentNullException(nameof(sourceScreen));
            }
            if (targetScreen is null)
            {
                throw new ArgumentNullException(nameof(targetScreen));
            ...
            {
                scalingFactorX =
                    sourceScreen.Bounds.Width <= 0
                        ? 1
                        : targetScreen.Bounds.Width / (double)sourceScreen.Bounds.Width;
                scalingFactorY =
                    sourceScreen.Bounds.Height <= 0
                        ? 1
                        : targetScreen.Bounds.Height / (double)sourceScreen.Bounds.Height;
            }
        ...
        public static bool TrySwitchScreens(
            this ContainerControl container,
            Screen targetScreen,
            bool withScaling
        )
        {
            ...
            if (!container.Location.TryGetScreen(out Screen sourceScreen, out _))
            {
                return false;
            }
            return container.TrySwitchScreens(sourceScreen, targetScreen, withScaling);
        ...
        )
        {
            ...
            if (
                !container.Location.TrySwitchScreens(
                    sourceScreen,
                    targetScreen,
                    withScaling,
                    out newPoint
        ...
        {
            newPoint = default;
            if (sourceScreen is null || targetScreen is null)
            {
                return false;
            }
