...
#nullable enable
    ...
    public static class LazyExtension
    {
        ...
        public static Lazy<T> ToLazyValue<T>(this T value)
            where T : struct
        {
            return new Lazy<T>(() => value);
        }

        public static LazyTry<T> ToLazyTry<T>(this T value)
            where T : class
        {
            return new LazyTry<T>(value.Return);
        }

        public static LazyTry<T> ToLazyTryValue<T>(this T value)
            where T : struct
        {
        ...
        public static AsyncLazy<T> ToAsyncLazy<T>(this T value)
            where T : class
        {
