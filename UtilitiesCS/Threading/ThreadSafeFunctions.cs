...
namespace UtilitiesCS.Threading
{
    ...
    {
        public static void AddThreadSafe(
            this ref double source,
            double amount,
            int maxAttempts = 100
        )
        {
        ...
        internal static void AddThreadSafe(
            this ref double source,
            double amount,
            double limit,
            int maxAttempts
        )
        {
            ...
            while (startingValue != exchangeValue)
            {
                ...
                if (temp > limit)
                {
                    exchangeValue = Interlocked.CompareExchange(ref source, limit, startingValue);
                }
                else
                {
                    exchangeValue = Interlocked.CompareExchange(ref source, temp, startingValue);
        ...
        internal static void SubtractThreadSafe(
            this ref double source,
            double amount,
            double limit,
            int maxAttempts
        ...
        public static void IncrementThreadSafe(
            this ref double source,
            double maxValue,
            int maxAttempts
        )
        ...
        public static void DecrementThreadSafe(
            this ref double source,
            double minValue,
            int maxAttempts
        )
        ...
        public static void AdjustThreadSafe(
            this ref double source,
            Func<double, double> adjustmentFactory,
            Func<double, double> limitFactory
        )
        {
