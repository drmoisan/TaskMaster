...
Public Class TaskRibbonController
    ...
    'Public Sub New(TaskRibbon As TaskRibbonViewer, AppGlobals As IApplicationGlobals)
    '    _viewer = TaskRibbon
    '    _globals = AppGlobals
    'End Sub
    ...
    Friend Sub ToggleEventsHook()
        If blHook = True Then
            Globals.ThisAddIn.Events_Unhook()
            blHook = False
            _viewer.BtnHookToggle.Label = "Hook Events"
            MsgBox("Events Disconnected")
        Else
            Globals.ThisAddIn.Events_Hook()
            _viewer.BtnHookToggle.Label = "UnHook Events"
            blHook = True
