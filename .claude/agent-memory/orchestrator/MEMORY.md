...
- [Sibling item can merge DURING your preparation](sibling-item-can-merge-during-your-preparation.md) — origin/main moves under a running subagent; git status stays clean, so compare HEAD:file vs origin/main:file
