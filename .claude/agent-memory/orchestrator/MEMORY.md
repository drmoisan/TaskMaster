...
- [Pre-implementation gate wants `lifecycle_ready` bool](preimplementation-gate-needs-lifecycle-ready-bool.md) — a `lifecycle_readiness` object satisfies nothing; hook reads the AGENT worktree cwd
