...
- [Multi-location fact residuals drive preflight rounds](multi-location-fact-residuals-drive-preflight-rounds.md) — site-specific correction prompts MANUFACTURE next round's residuals; pair every named edit with a sweep clause, and decompose a rising count before blaming the planner
