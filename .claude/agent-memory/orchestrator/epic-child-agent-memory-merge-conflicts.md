...
Same underlying gotcha as [[parallel-epic-children-conflict-on-agent-memory-index]] (the indexed entry for this pattern) and [[epic-child-rebase-shared-memory-conflict]].
