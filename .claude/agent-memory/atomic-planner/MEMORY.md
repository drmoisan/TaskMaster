...
- [#648](project_648_ungated_static_swap_plan_seams.md) — vstest prints no `Failed:` on green; dotnet-tools.json at repo ROOT; scoped coverage run can't meet the solution-wide 80% floor; two assemblies both declare `WpfUiDispatcherTests`
