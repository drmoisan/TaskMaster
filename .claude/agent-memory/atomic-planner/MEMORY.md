...
- [#656](project_656_closecompleted_guard_plan_seams.md) — neither test wrapper accepts a TestCaseFilter override; coverage runner prints no percentage; prove MSBuild non-vacuity by assembly mtime, not log text
