...
- [#497 F16 capstone plan seams](project_497_f16_capstone_plan_seams.md) — python.md DOES exist (research wrong); 3 manifest placeholders not 5; F15 folder absent; AC8 closure must follow the QA loop; PS branch coverage unmeasurable
