...
- `- Status: Promoted -> docs/features/active/<slug>/` omitting the `YYYY-MM-DD-` prefix and `-<issue#>` suffix of the actual active folder (seen on issue #424, 2026-08-06; recurred on issues #438, 2026-08-08 and #680, 2026-08-28 — treat as the scaffold's standing behavior).
