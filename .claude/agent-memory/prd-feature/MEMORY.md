...
- [full-bug means spec.md is the only AC source](feedback_full_bug_spec_only.md) — default to no user-story.md; if a caller demands one, make it checkbox-free narrative with an explicit banner
