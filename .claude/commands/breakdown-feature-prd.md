---
description: 'Create a Product Requirements Document (PRD) for a new feature based on a parent Epic. Use when you need a detailed feature PRD to serve as input for technical specification and implementation planning.'
argument-hint: '<epic-path> <feature-idea> [target-users]'
---
