---
description: 'Reference guide for JavaScript/TypeScript Jest testing best practices, including test structure, mocking strategies, async testing, and React Testing Library patterns. Use when writing or reviewing Jest tests in JavaScript or TypeScript projects.'
---

# JavaScript/TypeScript Jest Testing Best Practices

Apply the following best practices when writing JavaScript or TypeScript tests using Jest.
