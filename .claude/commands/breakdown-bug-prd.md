---
description: 'Create a bug specification (spec.md) after a GitHub issue is created. Use when documenting a confirmed bug as the single source of truth for engineering and QA.'
---
