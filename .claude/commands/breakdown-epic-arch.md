---
description: 'Create a high-level technical architecture specification for an Epic based on a Product Requirements Document. Use when you have an Epic PRD and need a corresponding architecture document.'
argument-hint: '<epic-prd-path>'
---
