...
Follow the operating rules in the `task-researcher` skill definition (research-only, write to `artifacts/research/`, evidence-based). Do not restate those rules in the research notes; apply them.
