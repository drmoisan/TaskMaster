---
description: 'Create a detailed feature implementation plan based on a Feature PRD, following Epoch monorepo structure. Use when you need a thorough technical implementation plan for a feature.'
argument-hint: '<feature-prd-path>'
---
