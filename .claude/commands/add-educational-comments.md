---
description: 'Add educational comments to a specified code file. Use when you want to annotate a file with learning-oriented explanations for a given audience and knowledge level.'
argument-hint: '<file> [Comment Detail=2] [Repetitiveness=2] [User Knowledge=2] [Educational Level=1] [Line Number Referencing=yes]'
---
...
```text
[user]
> /add-educational-comments output_name.py Comment Detail = 1, Repetitiveness = 1, Line Numer = no
```
