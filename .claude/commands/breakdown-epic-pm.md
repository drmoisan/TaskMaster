---
description: 'Create an Epic Product Requirements Document (PRD) for a new epic. Use when translating a high-level idea into a structured Epic PRD to be used as input for architecture and planning.'
argument-hint: '<epic-idea> [target-users]'
---
