...
description: 'Checkpoint schema and resume protocol for long-running C# orchestration workflows. Use when a workflow spans multiple delegations and must resume deterministically after interruption.'
