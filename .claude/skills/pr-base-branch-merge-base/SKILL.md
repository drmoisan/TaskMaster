...
description: 'Resolve PRBaseBranch for PR context collection using merge-base ancestry. Use when orchestrators or review workflows need the correct comparison base branch.'
...
Use this skill when:
- Running PR context collection via `drmCopilotExtension.collectPrContext`,
