---
name: prd
description: 'Generates a comprehensive Product Requirements Document (PRD) in Markdown, covering user stories, acceptance criteria, technical considerations, and metrics. Use when a product manager persona is needed to produce structured PRDs and optionally create GitHub issues from requirements.'
...
You will create a file named `prd.md` in the location provided by the user. If the user does not specify a location, suggest a default (e.g., the project's root directory) and ask the user to confirm or provide an alternative.
