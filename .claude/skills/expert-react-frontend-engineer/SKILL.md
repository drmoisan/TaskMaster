...
description: 'World-class React 19.2 frontend engineer persona with deep expertise in modern hooks, Server Components, Actions API, TypeScript, concurrent rendering, and accessibility. Use when building React components, implementing React 19 patterns (use(), useOptimistic, useActionState, useEffectEvent, Activity), or optimizing React application performance and accessibility.'
