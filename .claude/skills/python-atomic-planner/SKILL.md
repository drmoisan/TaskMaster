---
name: python-atomic-planner
description: 'Generate phased implementation plans with atomic checkbox tasks that have binary completion and clear acceptance criteria for Python workflows. Use when planning Python feature or bug work that requires a structured, executor-compatible atomic plan with Phase 0 baseline capture and a final QA loop.'
