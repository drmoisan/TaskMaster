---
name: pr-author
description: 'Writes GitHub-ready pull request descriptions from PR context artifacts (pr_context.summary.txt + pr_context.appendix.txt). Use when generating a PR body that must be feature-first, accurate to commits and changed files, and strictly non-hallucinatory about issue/PR references.'
...
5. **Verification**
   ...
   - Provide concrete commands aligned to repo norms
