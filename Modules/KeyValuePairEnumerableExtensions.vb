...
Module KeyValuePairEnumerableExtensions
    ''' <summary>
    ...
    <Extension()>
    Function ToSortedDictionary(Of TKey, TValue)(ByVal l As IEnumerable(Of KeyValuePair(Of TKey, TValue))) As SortedDictionary(Of TKey, TValue)
    ...
    ''' <returns>A Sorted Dictionary</returns>
    <Extension()>
    Function ToDictionary(Of TKey, TValue)(ByVal l As IEnumerable(Of KeyValuePair(Of TKey, TValue))) As Dictionary(Of TKey, TValue)
