...
'        Dim blToday As Boolean = False
'        Dim blBullpin As Boolean = False
...
'        Dim flags As FlagParser = New FlagParser(strCats_All)


'        EmailForm = New TaskViewer                                                          'Initialize the dialogue box
