...
namespace CleanProjectToTest
{
    ...
    public static class TestSerDic
    {
        ...
        public static void WriteDictJSON(Dictionary<string, string> dict, string filepath)
        {
            File.WriteAllText(filepath, JsonConvert.SerializeObject(dict, Formatting.Indented));
        }

        public static Dictionary<string, string> GetDictJSON(string filepath)
        {
